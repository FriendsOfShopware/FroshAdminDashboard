import template from './frosh-widget-payment-method.html.twig';
...
export default Shopware.Component.wrapComponentConfig({
    ...
    methods: {
        async fetchPaymentMethods(
            ...
            const methods = await this.repositoryFactory.create('payment_method').search(nameCriteria, Shopware.Context.api);

            const rows: BreakdownRow[] = methods
